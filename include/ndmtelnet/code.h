...
/**
 * Number of special codes group used to form returned values which are
 * not tied to any class (global error codes).
 */
 ...
 * @param code Code of returned value to check.
 *
 * @b Returns A nonzero value if the code type is @a critical.
 */

#define NDM_CRITICAL(code)			(((code) & 0xc0000000) == 0xc0000000)
